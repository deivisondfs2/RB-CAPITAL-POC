...
/**
 * Provides the local service interface for Favorito. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FavoritoLocalServiceUtil
...
public interface FavoritoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FavoritoLocalServiceUtil} to access the favorito local service. Add custom service methods to {@link com.favorito.service.impl.FavoritoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
